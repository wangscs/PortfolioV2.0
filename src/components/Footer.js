...
function Footer() {
  ...
  return (
    <footer>
      ...
      <hr></hr>
      <a className="footer-link" rel="noopener noreferrer" target="_blank" href="https://www.github.com/wangscs">
        <img className="link-img" src={githubPic} alt="GitHub Logo Profile For Steven Wang"/>
      </a>
      <a className="footer-link" rel="noopener noreferrer" target="_blank" href="https://www.linkedin.com/in/wangscs">
